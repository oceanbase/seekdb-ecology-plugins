...
The `REFRESH_INDEX` procedure is used to incrementally refresh the vector index.
...
| refresh_threshold | The number of incremental data entries. |
| refresh_type | The type of refresh. The optional value is `FAST`. |
