...
* Error reason: Internal error. During the seekdb restart, the process receives a signal such as `kill -15`, causing the process to exit. The `seekdb.log` file will display the above error code.
