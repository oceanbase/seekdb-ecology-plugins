...
* You have installed or created the embedding function (`embeddingFunction`) you intend to use. The embedding function is used for vectorization when adding to or querying the collection. If you do not specify an embedding function, the default embedding function is used. Before using the default, run the following command to install `@seekdb/default-embed`. For more information, see [Default embedding function](../../60.embedding-funcations-of-seekdb-js/100.default-embedding-function-of-seekdb-js.md).
