...
* Creating dense/sparse vector indexes is supported. For details, see [vector index](200.vector-index/300.dense-vector-index/100.dense-vector-index-overview.md).
...
* [Create vector indexes](200.vector-index/300.dense-vector-index/100.dense-vector-index-overview.md)
