...
To use events, you must have the `GRANT EVENT` privilege. For more information about seekdb privileges, see [Privilege types in seekdb](../../../400.guides/500.manage/300.security/300.access-control/200.user-and-permission/100.permission-classification.md)].
