...
| 插件名称                                                                             | 使用场景                  | 核心功能                                                                           |
| --------------------------------------------------------------------------------------- | ------------------------- | -------------------------------------------------------------------------------------- |
| [Seekdb Claude Code 插件](./claudecode-plugin/README_CN.md)                             | 开发工具         | 为 Claude Code 提供 seekdb 数据库相关文档支持                 |
...
- **文档**：[Seekdb Claude Code 插件](./claudecode-plugin/README_CN.md)
...
| 插件名称                           | 文档链接                                                                      |
| ------------------------------------- | --------------------------------------------------------------------------------------- |
| Seekdb Claude Code 插件             | [Seekdb Claude Code 插件](./claudecode-plugin/README_CN.md)                             |
...
- 确保 seekdb 版本兼容性（推荐 ≥ 1.0.0）。

- 插件设计用于与 seekdb 的最新功能和能力协同工作。
